          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            {onToggleLanguage && (
              <button
                ...
                className="px-2 py-1.5 rounded-2xl transition-all cursor-pointer flex items-center justify-center gap-1 active:scale-95 bg-white/10 hover:bg-white/20 text-slate-200 border border-white/10 shadow-2xs font-black text-xs"
              >
            ...
            {/* Sync Simulator Live Push Button */}
            {onOpenSyncModal && (
              <button
                id="header-sync-simulator-btn"
                onClick={onOpenSyncModal}
                title="Sync Live Simulator Telemetry & Push Data"
                aria-label="Sync Simulator"
                className="px-2.5 py-1.5 rounded-2xl transition-all cursor-pointer flex items-center justify-center gap-1 active:scale-95 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white shadow-xs font-black text-xs border border-emerald-400/30"
              >
                <RefreshCw className={`w-3.5 h-3.5 text-emerald-200 ${isSyncing ? "animate-spin" : ""}`} />
                <span className="text-[11px] font-black tracking-tight">Sync</span>
              </button>
            )}
              ...
              {isEyeMenuOpen && (
                ...
                >
                  ...
                  <div className="p-1 space-y-1">
                    ...
                    {/* Item 7: Simulator Sync & Push Hub */}
                    {onOpenSyncModal && (
                      <button
                        id="eye-menu-sync-simulator"
                        onClick={() => {
                          onOpenSyncModal();
                          setIsEyeMenuOpen(false);
                        }}
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <div className="text-left">
                            <div className="leading-tight">Simulator Sync Hub</div>
                            <div className="text-[10px] text-slate-400 font-normal">
                              Live API push & sync
                            </div>
                          </div>
