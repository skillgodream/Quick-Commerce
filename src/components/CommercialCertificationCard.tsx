  ...
  const criteriaList: CriterionDetail[] = [
    {
      ...
      met: modulesDone >= 19,
      metric: `${modulesDone}/19 LMS modules completed`,
      metricHi: `${modulesDone}/19 एलएमएस मॉड्यूल पूरे`,
      benchmark: "19/19 LMS digital video modules completed with ≥85% quiz average",
      benchmarkHi: "सभी 19 डिजिटल एलएमएस वीडियो मॉड्यूल पूर्ण (कम से कम 85% क्विज़ औसत)",
