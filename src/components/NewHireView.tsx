      ...
      <div className="max-w-md mx-auto p-1.5 sm:p-2 pb-36 select-none min-h-screen bg-white text-slate-900 relative font-ref antialiased">
        ...
        <div className="bg-[#12131c] rounded-[40px] px-5 pt-5 pb-12 mb-7 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)] flex flex-col text-white border border-white/10 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-8 relative z-20">
            ...
            {/* Top-Right Controls: Simulator, Notification (Bell) & Language Switcher */}
            <div className="flex items-center gap-2">
              {onOpenSimulator && (
                <button
                  type="button"
                  onClick={onOpenSimulator}
                  className="w-10 h-10 rounded-full bg-cyan-500/20 hover:bg-cyan-500/30 backdrop-blur-md border border-cyan-300/30 flex items-center justify-center text-cyan-200 hover:text-white transition-all cursor-pointer shadow-sm"
                  title="Open Simulator Lab"
                  aria-label="Open Simulator Lab"
                >
