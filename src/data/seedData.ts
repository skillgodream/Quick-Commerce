...
export const initialRahul: NewHire = {
  ...
  statusReason: "Reported aisle confusion (Aisles 4-8) + frequent manager location support needed",
  ...
  daysHistory: [
    ...
    },
    {
      ...
      statusAtEnd: "Doing well",
      statusReason: "Independent picking started.",
    },
    {
      dayNumber: 3,
      date: "Day 3 (Today)",
      ...
      identifiedPattern: {
        ...
        diagnosis: "New hire reports confusion finding product locations + Manager reports frequent support needed. This confirms spatial layout friction rather than lack of effort.",
        category: "Environment",
      ...
      recommendedAction: {
        ...
        description: "Pair with Senior Picker Vikram for a 15-minute floor walkthrough focusing on Aisles 4-8 (beverages & dairy cold room) shelf labeling.",
      ...
      statusReason: "Aisle navigation friction; recommended buddy walkthrough pending.",
    },
    {
      dayNumber: 4,
      date: "Day 4 (Wed)",
      ...
      managerSignal: {
        ...
        state: "Needs support",
        issueCategory: "Process",
        notes: "Completed walkthrough with Vikram. Checking if picking performance recovers.",
        timestamp: "03:45 PM",
      },
      recommendedAction: {
        id: "act-r-d3",
      ...
      actionOutcome: {
        ...
        improved: "partial",
        notes: "Showed bin numbering schema (Rack-Bay-Level). Rahul applied bin logic during afternoon.",
      },
      statusAtEnd: "Needs attention",
      statusReason: "Action executed; awaiting shift performance confirmation.",
    },
    {
      dayNumber: 5,
      date: "Day 5 (Thu)",
      dailySignal: {
        id: "sig-r-d5",
        dayNumber: 5,
        rawText: "I can find dairy and beverages without stopping now.",
        inputMethod: "voice",
        issue: "None / On track",
        confidence: "High",
        possibleImpact: "Target achieved",
        category: "General",
        summary: "Navigating aisles 4-8 independently.",
        companionResponse: "Fantastic work Rahul! You are right on target.",
        timestamp: "02:45 PM",
      },
      managerSignal: {
        id: "mgr-r-d5",
        ...
        state: "Doing well",
        issueCategory: undefined,
        notes: "No longer calling for location help.",
        timestamp: "04:00 PM",
      },
      actionOutcome: {
        id: "out-r-d5",
        ...
        improved: "yes",
        notes: "Situation fully improved. Rahul is navigating independently.",
      },
      statusAtEnd: "Doing well",
      statusReason: "Intervention succeeded. Navigating aisles independently.",
    },
  ],
};
...
export const initialCohort: NewHire[] = [
  initialRahul,
  {
    ...
    buddy: "Anita M.",
    status: "Doing well",
    statusReason: "Consistently high quiz performance and demonstrated module capability.",
  ...
  },
  {
    ...
    buddy: "Vikram R.",
    status: "At risk",
    statusReason: "Accuracy alert due to variant confusion (e.g. 250g vs 500g pouch).",
    ...
    daysHistory: [
      {
        ...
        identifiedPattern: {
          ...
          patternConfidence: "High",
          diagnosis: "Worker reports identical visual packaging + Manager catches 3 mis-picks at dispatch QC. Accuracy is at risk.",
          category: "Process",
          connectedSignalSummary: [
        ...
        statusAtEnd: "At risk",
        statusReason: "Accuracy alert; requires 10-min supervisor variant check demo.",
      },
    ],
  },
];
